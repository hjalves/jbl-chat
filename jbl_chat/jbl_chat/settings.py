...
MIDDLEWARE = [
    ...
    "chat.middleware.last_seen_middleware",
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                "chat.processors.navigation_processor",
...
# Fixtures
# https://docs.djangoproject.com/en/3.2/ref/settings/#std-setting-FIXTURE_DIRS

FIXTURE_DIRS = [PROJ_DIR / "fixtures"]
